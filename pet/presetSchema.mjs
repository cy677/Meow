import { CAT_APPEARANCES, MOUTH_MODES } from '../src/catAppearance/catalog.js';
...
export const PARAM_FIELDS = {
  ...
  shape: [
    ...
    select('mouthMode', '口型动作', MOUTH_MODES.map(item => [item.id, item.name])),
...
export function fieldVisible(category, key, params) {
  ...
  if (key === 'mouthMode') return params.catAppearance === 'leaf';
