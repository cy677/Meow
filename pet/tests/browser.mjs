...
try{
  ...
  await child.screenshot({path:fileURLToPath(new URL('child-desktop.png',out)),fullPage:true});
  await parent.screenshot({path:fileURLToPath(new URL('parent-desktop.png',out)),fullPage:true});
  ...
  await parent.screenshot({path:fileURLToPath(new URL('parent-catalog.png',out)),fullPage:true});
  ...
  await child.screenshot({path:fileURLToPath(new URL('child-ipad-1024.png',out)),fullPage:true});
