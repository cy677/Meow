...
const shot=(page,name)=>page.screenshot({path:fileURLToPath(new URL(name+'.png',out)),fullPage:true});
try {
  ...
  await parent.locator('#preset-dialog').screenshot({path:fileURLToPath(new URL('pad-parent-preset.png',out))});
